...
def training_vim_test(train_x, train_y, test_x, test_y, epoch, name):
    ...
    model_save_path = os.path.join(current_dir, 'pengujian_split_data', '80-20', 'vim', 'vim_model_1.pth')
...
def main():
    ...
    # Save the trained model
    model_save_path = os.path.join(current_dir, 'pengujian_split_data', '80-20', 'cnn', 'cnn_model_1.pth')
