...
def training_vim_test(train_x, train_y, test_x, test_y, epoch, name):
    ...
    model_save_path = os.path.join(current_dir, 'pengujian', 'pengujian_epoch', 'vim', 'vim_model_70_0.pth')
...
def main():
    ...
    plot_vim_combined(
        ...
        name='training_performance_vim_70_epoch_0'
    )
    test_mse, test_corr, outputs_flat, targets_flat = test_vim(model, test_x, test_y)
    plot_test_results(outputs_flat, targets_flat, test_corr, test_mse, name='R_performace_vim_70_epoch_0')
